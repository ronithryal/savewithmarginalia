  ...
  public: {
    Tables: {
      ...
      quotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "quotes_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "articles"
            referencedColumns: ["id"]
      ...
      thread_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "thread_items_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "articles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "thread_items_quote_id_fkey"
            columns: ["quote_id"]
            isOneToOne: false
            referencedRelation: "quotes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "thread_items_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
